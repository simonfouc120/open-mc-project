...
# set a high density for the materials to check if openmc can handle it with a loop
for material in material_dict.values():
    material.set_density('g/cm3', 1e3)
...
mesh_tally_xy_photons = mesh_tally_dose_plane(name_mesh_tally = "flux_mesh_photons_xy", particule_type='photon', plane="xy",
                                      bin_number=500, lower_left=(-300.0, -300.0), upper_right=(300.0, 300.0),
