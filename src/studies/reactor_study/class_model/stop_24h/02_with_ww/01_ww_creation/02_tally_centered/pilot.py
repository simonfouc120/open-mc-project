...
tally_sphere_dose.filters.append(mesh_filter)  # <-- Add this line

tallys.append(tally_sphere_dose)

tallys.export_to_xml()

wws = openmc.lib.WeightWindows.from_tally(tally_sphere_dose, particle='photon')



settings.max_history_splits = 10_000  
settings.weight_window_generators = [wws]
