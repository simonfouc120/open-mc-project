...
mesh_tally_neutron_xy_dose = mesh_tally_dose_xy(name_mesh_tally = "dose_mesh_neutrons_xy", particule_type='neutron', 
...
mesh_tally_photon_xy_dose = mesh_tally_dose_xy(name_mesh_tally = "dose_mesh_photons_xy", particule_type='photon',
                                      bin_number=400, lower_left=(-10.0, -10.0), upper_right=(10.0, 10.0),
                                      z_thickness= 4.0, z_value=0.0)
...
# Load the mesh tally for neutrons
mesh_tally_neutron_xy = load_mesh_tally_dose(cwd=CWD, statepoint_file=statepoint_file, name_mesh_tally="dose_mesh_neutrons_xy",
                                        n_per_second=neutrons_emitted_per_second,
                                        bin_number=400, lower_left=(-10.0, -10.0), upper_right=(10.0, 10.0),
                                        zoom_x=(-10, 10), zoom_y=(-10.0, 10.0), plane="xy")

# Load the mesh tally for photons
mesh_tally_photon_xy = load_mesh_tally_dose(cwd=CWD, statepoint_file=statepoint_file, name_mesh_tally="dose_mesh_photons_xy",
                                        n_per_second=neutrons_emitted_per_second,  
                                        particule_type='photons', 
                                        bin_number=400, lower_left=(-10.0, -10.0), upper_right=(10.0, 10.0),
                                        zoom_x=(-10, 10), zoom_y=(-10.0, 10.0), plane="xy")
